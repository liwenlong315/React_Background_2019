/*
商品的添加/修改子路由组件
（页面代码虽然模块分类但需注意图片功能也就是Pictures-wall.jsx文件
没有写好请删除图片等相关的代吗在测试提交，否则在提交时会报错。完成此文件所有代码
不去提交不会报错添加/修改功能可点机详情等功能都可实现）
*/
